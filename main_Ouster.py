...
from RandLANet_Ouster import Network
from tester_Ouster import ModelTester
...
class SemanticKITTI:
    def __init__(self, train_id, test_id):
        self.name = 'Ouster'
        self.dataset_path = BASE_DIR + '/data/Ouster_crop'
        self.label_path = join(self.dataset_path, 'labels')
        self.point_path = join(self.dataset_path, 'points')
        ...
        self.train_list = DP.getDataFiles(self.point_path + '/' + train_id)
        self.test_list = DP.getDataFiles(self.point_path + '/' + test_id)
    ...
    def get_batch_gen(self, split):
        if split == 'training':
            ...
            num_per_epoch = int(len(self.test_list) / cfg.val_batch_size) * cfg.val_batch_size
            path_list = self.test_list
            for test_file_name in path_list:
                points = np.load(self.point_path + '/' + test_file_name)
    ...
    def init_input_pipeline(self):
        ...
        self.batch_train_data = self.batch_train_data.map(map_func=map_func) # Mapping function
        self.batch_test_data = self.batch_test_data.map(map_func=map_func)

        self.batch_train_data = self.batch_train_data.prefetch(cfg.batch_size) # Fetch batch_size size data everytime
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_list', type=str, default='ouster_train_csv_file_list.txt', help='options: train')
    parser.add_argument('--test_list', type=str, default='ouster_test_csv_file_list.txt', help='options: test')
    # parser.add_argument('--model_path', type=str, default='None', help='pretrained model path')
    parser.add_argument('--model_path', type=str, default='/mnt/eb995bf2-ea8f-4a12-92ce-75df799099f8/RandLA-Net-master/results/Log_2023-05-25_13-19-36/snapshots/snap-3011', help='pretrained model path')
    # Cropped old data
    # parser.add_argument('--model_path', type=str,
    #                     default='/mnt/eb995bf2-ea8f-4a12-92ce-75df799099f8/RandLA-Net-master/results/Cropped_data_model/snapshots/snap-32320',
    ...
    dataset = SemanticKITTI(train_list, test_list)
    dataset.init_input_pipeline()
    
    # Visualize parameters
    print("Maximum epoch: " + str(cfg.max_epoch))
    print("KNN num: " + str(cfg.k_n));
    print("# of classes: " + str(cfg.num_classes));
    print("Save the model? : " + str(cfg.saving));
    print("Saving path? : " + str(cfg.saving_path));
    ...
    if Mode == 'train':
        ...
        if FLAGS.model_path is not 'None':
            ...
            chosen_folder = 'results/Log_2021-09-09_23-46-04'
        ...
        with tf.Session() as sess:
            ...
            while True:
                ...
                labels = labels[0, :]
                Plot.draw_pc_sem_ins(pc_xyz[0, :, :], labels)
